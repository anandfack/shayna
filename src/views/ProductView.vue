                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="product-details text-left">
                                ...
                                <div class="quantity">
                                    <router-link class="primary-btn pd-cart" to="/shoppingchart">Add To Cart</router-link>
                                </div>
                            </div>
                        </div>
                    </div>
...
<FooterShayna />
<!-- Akhir Memanggil Components -->
</div>
</template>

<script>
// Import Name dari file Components
